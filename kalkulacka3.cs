    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!ValidOperation)
            {
                ...
                else if (operation == "odecet")
                {
                    result = a - b;
                    Console.WriteLine("vysledek je " + result);
                    ValidOperation = true;
                }
                else if (operation == "nasobeni")
                {
                    result = a * b;
                    Console.WriteLine("vysledek je " + result);
                    ValidOperation = true;
                }
                else if (operation == "deleni")
                {
                    if (b == 0)
                    {
            ...
            while (!ValidOperationTwo)
            {
                ...
                string operationTwo = Console.ReadLine();
                if (operationTwo == "soucet")
                {
                    resultTwo = result + c;
                    Console.WriteLine("vysledek je " + resultTwo);
                    ValidOperationTwo = true;
                }
                else if (operationTwo == "odecet")
                {
                    resultTwo = result - c;
                    Console.WriteLine("vysledek je " + resultTwo);
                    ValidOperationTwo = true;
                }
                else if (operationTwo == "nasobeni")
                {
                    resultTwo = result * c;
                    Console.WriteLine("vysledek je " + resultTwo);
                    ValidOperationTwo = true;
                }
                else if (operationTwo == "deleni")
                {
                    if (c == 0)
                    {
                        Console.WriteLine("nelze delit nulou");
